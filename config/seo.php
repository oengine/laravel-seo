...
return [
     ...
     * to the root domain and not relative to the current URL.
     * is a great package to generate sitemaps for your application.
     */
    'sitemap' => function () {
        return route('_oengine.sitemap');
    },
    ...
    'robots' => [
         ...
         * Overwrite it with the robots attribute of the SeoInfo object. `SeoInfo->robots = 'noindex, nofollow'`
        ...
        /**
         * Force set the robots `default` value and make it impossible to overwrite it. (e.g. via SeoInfo->robots)
    ...
    'image' => [
         ...
         * don't have an image set via an associated ->seo model or via the ->getDynamicSeoInfo() method.
    ...
    'author' => [
         ...
         * don't have an author set via an associated ->seo model or via the ->getDynamicSeoInfo() method.
         */
        'fallback' => null,
    ],
